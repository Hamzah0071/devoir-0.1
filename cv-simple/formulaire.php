<?php
// ══════════════════════════════════════════════════════════════════
//  CV GENERATOR — Formulaire de saisie
// ══════════════════════════════════════════════════════════════════
                ...
                <div class="form-col">
                    ...
                    <div class="field-group">
                        ...
                        <input
                            ...
                            value="<?= htmlspecialchars($anciens['titre'] ?? '') ?>"
                            required
                        >
                    </div>
                    ...
                    <div class="field-group">
                        ...
                        <input
                            ...
                            value="<?= htmlspecialchars($anciens['contact'] ?? '') ?>"
                        >
                    </div>
                    ...
                    <div class="field-group">
                        ...
                        <textarea
                            ...
                            rows="5"
                        ><?= htmlspecialchars($anciens['experience'] ?? '') ?></textarea>
                    </div>
                    ...
                    <div class="field-group">
                        ...
                        <textarea
                            ...
                            placeholder="PHP&#10;HTML / CSS&#10;JavaScript"
                            rows="4"
                        ><?= htmlspecialchars($anciens['competences'] ?? '') ?></textarea>
                    </div>
                    ...
                    <div class="field-group">
                        ...
                        <textarea
                            ...
                            placeholder="Lecture&#10;Sport&#10;Musique"
                            rows="3"
                        ><?= htmlspecialchars($anciens['loisirs'] ?? '') ?></textarea>
                    </div>
